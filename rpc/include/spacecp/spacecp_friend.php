...
//		showmessage('no_privilege_addfriend');
		$msg = rpclang('home', 'no_privilege_addfriend');
        jsonexit("{\"status\":\"$msg\"}");
	}

	if($uid == $_G['uid']) {
//		showmessage('friend_self_error');
		$msg = rpclang('home', 'friend_self_error');
        jsonexit("{\"status\":\"$msg\"}");
	}

	if(friend_check($uid)) {
//		showmessage('you_have_friends');
		$msg = rpclang('home', 'you_have_friends');
        jsonexit("{\"status\":\"$msg\"}");
	}
...
//		showmessage('space_does_not_exist');
		$msg = rpclang('home', 'space_does_not_exist');
        jsonexit("{\"status\":\"$msg\"}");
	}
...
//			showmessage('enough_of_the_number_of_friends_with_magic');
			$msg = rpclang('home', 'enough_of_the_number_of_friends_with_magic');
            jsonexit("{\"status\":\"$msg\"}");
		} else {
//			showmessage('enough_of_the_number_of_friends');
			$msg = rpclang('home', 'enough_of_the_number_of_friends');
            jsonexit("{\"status\":\"$msg\"}");
		}
	}
...
//			showmessage('waiting_for_the_other_test');
			$msg = rpclang('home', 'waiting_for_the_other_test');
            jsonexit("{\"status\":\"$msg\"}");
		}
...
//			showmessage('request_has_been_sent', dreferer(), array(), array('showdialog'=>1, 'showmsg' => true, 'closetime' => true));
            $msg = rpclang('home', 'request_has_been_sent');
            jsonexit("{\"status\":\"$msg\"}");
