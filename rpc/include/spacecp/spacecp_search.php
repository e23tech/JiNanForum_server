...
if(!empty($_GET['searchsubmit']) || !empty($_GET['searchmode'])) {
	...
	$jsonarr['residecityhtml'] = $residecityhtml;
//	$jsonarr['birthcityhtml'] = $birthcityhtml;
//	$moredayhtml = '<option value="29">29</option><option value="30">30</option><option value="31">31</option>';
//	$birthdayhtml = $birthdayhtml.$moredayhtml;
//	$jsonarr['birthyeayhtml'] = $birthyeayhtml;
//	$jsonarr['birthmonthhtml'] = $birthmonthhtml;
//	$jsonarr['birthdayhtml'] = $birthdayhtml;
	jsonexit($jsonarr);
}
?>